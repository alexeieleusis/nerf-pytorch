...
def load_dv_data(scene="cube", basedir="/data/deepvoxels", testskip=8):
    ...
    H = 512
    W = 512
    deepvoxels_base = f"{basedir}/train/{scene}/"
    ...
    testposes = dir2poses(f"{basedir}/test/{scene}/pose")
    testposes = testposes[::testskip]
    valposes = dir2poses(f"{basedir}/validation/{scene}/pose")
    ...
    testimgd = f"{basedir}/test/{scene}/rgb"
    ...
    valimgd = f"{basedir}/validation/{scene}/rgb"
